...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        images = new ArrayList<>(Arrays.asList(getDrawable(R.drawable.ic_number1), getDrawable(R.drawable.ic_number1),
                getDrawable(R.drawable.ic_number2), getDrawable(R.drawable.ic_number2), getDrawable(R.drawable.ic_number3),
                getDrawable(R.drawable.ic_number3), getDrawable(R.drawable.ic_number4), getDrawable(R.drawable.ic_number4),
                getDrawable(R.drawable.ic_number5), getDrawable(R.drawable.ic_number5), getDrawable(R.drawable.ic_number6),
                getDrawable(R.drawable.ic_number6), getDrawable(R.drawable.ic_number7), getDrawable(R.drawable.ic_number7),
                getDrawable(R.drawable.ic_number8), getDrawable(R.drawable.ic_number8)));
